...
def prepare_exercise(template):
    ...
    positions = _compute_positions(text, verbs)
    display = _create_display_text(text, verbs)
    ...
    # Shuffle verbs for the drag pool
    shuffled_verbs = list(verbs)
